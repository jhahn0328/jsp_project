...
%>
    ...
    <div class="container">
        <div class="jumbotron">
            <div class="container">
                <h1>웹 사이트 소개</h1>
                <p>이 웹 사이트는 통합게시판으로 날씨정보와 맛집정보를 포함하고 있습니다. 또한 카카오 로그인 서비스로 접근성을 높였습니다. 사용한 API는 Open Weather,Kakao Map,Login API입니다.</p>
                <p><a class="btn btn-primary btn-pull" href="https://developers.kakao.com/features/kakao" role="button">자세히 알아보기</a></p>
            </div>
        </div>
    </div>
    <div class="container">
